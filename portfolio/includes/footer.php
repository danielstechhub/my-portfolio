  ...
  <div class="container footer-inner">
    <div class="footer-brand">
      ...
      <ul class="social-links" aria-label="Social links">
        <li><a href="https://github.com/danielstechhub" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
        ...
        <li><a href="https://www.linkedin.com/in/ayodeji-oluwafemi-daniel-75254b363?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
        ...
        <li><a href="https://www.instagram.com/daniels_techpro.io?igsh=MXJhYWl4NmUwbm1hMg==" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M7 2h10a5 5 0 0 1 5 5v10a5 5 0 0 1-5 5H7a5 5 0 0 1-5-5V7a5 5 0 0 1 5-5Zm0 2a3 3 0 0 0-3 3v10a3 3 0 0 0 3 3h10a3 3 0 0 0 3-3V7a3 3 0 0 0-3-3H7Zm5 3.5A4.5 4.5 0 1 1 7.5 12 4.5 4.5 0 0 1 12 7.5Zm0 2A2.5 2.5 0 1 0 14.5 12 2.5 2.5 0 0 0 12 9.5Zm5.25-2.75a1 1 0 1 1-1 1 1 1 0 0 1 1-1Z"/></svg>
        </a></li>
        <li><a href="https://x.com/danielstechhub1" target="_blank" rel="noopener noreferrer" aria-label="X (Twitter)">
